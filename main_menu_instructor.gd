...
@onready var roomButton = $ButtonsSide/roomButton
@onready var manageButton = $ButtonsSide/manageButton
...
func _ready():
	...
	roomButton.connect("mouse_entered", Callable(self, "_on_button_hovered"))
	manageButton.connect("mouse_entered", Callable(self, "_on_button_hovered"))
...
func _on_room_button_pressed():
	get_tree().change_scene_to_file("res://room_selection.tscn")
	Global.button_click_sfx()

func _on_manage_button_pressed():
	get_tree().change_scene_to_file("res://manage.tscn")
	Global.button_click_sfx()

func _on_options_button_pressed():
	get_tree().change_scene_to_file("res://options_instructor.tscn")
	Global.button_click_sfx()
